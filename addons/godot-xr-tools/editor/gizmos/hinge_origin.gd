...
func _commit_handle(
		...
		p_handle_id: int,
		_secondary: bool, # This parameter isn't used
		p_restore: Variant,
		p_cancel: bool,
) -> void:
...
# Gets the limit of a hinge by handle
func _get_limit(
...
func _set_handle(
		p_gizmo: EditorNode3DGizmo,
		p_handle_id: int,
		_secondary: bool, # This parameter is never used
		p_camera: Camera3D,
...
# Sets the limit of a hinge by handle
func _set_limit(
		p_origin: XRToolsInteractableHingeOrigin,
		p_handle_id: int,
		p_limit: float,
