...
## Y offset of pointer
@export_custom(PROPERTY_HINT_NONE, "suffix:m") var y_offset := -0.013:
		set = set_y_offset

## Specifies how far our pointer tests for collisions
@export_custom(PROPERTY_HINT_NONE, "suffix:m") var distance := 10.0:
		set = set_distance
...
@export_custom(PROPERTY_HINT_NONE, "suffix:m") var target_radius := 0.05:
...
@export_custom(PROPERTY_HINT_NONE, "suffix:m") var suppress_radius := 0.2:
...
@export_custom(PROPERTY_HINT_NONE, "suffix:s") var hold_time := 2.0
