...
## Automatically adjusts its position to locate the palm of a hand
## (within limits).
...
func is_xr_class(xr_name: String) -> bool:
	return xr_name == "XRToolsHandPalmOffset"


## Sets the node we apply our transform to.
## Must be set before [method Node._enter_tree] is called for the first time.
