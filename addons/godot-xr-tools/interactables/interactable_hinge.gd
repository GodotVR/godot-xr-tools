...
@export var hinge_steps := 0.0: set = _set_hinge_steps

## Hinge position
@export var hinge_position := 0.0: set = _set_hinge_position

## Default position
@export var default_position := 0.0: set = _set_default_position

## Whether the hinge moves to the default position when released
