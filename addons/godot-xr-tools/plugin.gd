...
func _enter_tree():
	...
	_define_project_setting("godot_xr_tools/input/grip_threshold", TYPE_FLOAT, PROPERTY_HINT_RANGE, "0.2,0.8,0.05", 0.7)
	_define_project_setting("godot_xr_tools/input/snap_turning_deadzone", TYPE_FLOAT, PROPERTY_HINT_RANGE, "0.0,0.5,0.05", 0.25)
	_define_project_setting("godot_xr_tools/input/default_snap_turning", TYPE_BOOL, PROPERTY_HINT_NONE, "", true)

	_define_project_setting("godot_xr_tools/player/standard_height", TYPE_FLOAT, PROPERTY_HINT_RANGE, "1.0,2.5,0.05", 1.85)
